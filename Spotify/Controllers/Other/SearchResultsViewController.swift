...
final class SearchResultsViewController: UIViewController {
    ...
    func update(with results: [SearchResult]){
        ...
        self.sections = [
            ...
            SearchSection(title: "Albums", sections: albums),
            SearchSection(title: "Playlists", sections: playlists)
        ]
...
extension SearchResultsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .album(let album):
            ...
            let viewModel = SearchResultSubtitleTableViewCellViewModel(title: album.name, subtitle: album.artists.first?.name ?? "N/A", imageURL: URL(string: album.images.first?.url ?? ""))
        ...
        case .track(let track):
            ...
            let viewModel = SearchResultSubtitleTableViewCellViewModel(title: track.name, subtitle: track.artists.first?.name ?? "N/A", imageURL: URL(string: track.album?.images.first?.url ?? ""))
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return sections[section].sections.count
    }
